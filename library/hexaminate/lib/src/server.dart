...
//   void listen({String host = "0.0.0.0", int port = 8080, required void Function(HttpMultiServer server) callback}) async {
//     HttpMultiServer server = await HttpMultiServer.bind(host, port);
//     callback(server);
